...
const addToRemoveQueue = (toastId: string) => {
  ...
  const timeout = setTimeout(() => {
    ...
    dispatch({
      type: actionTypes.REMOVE_TOAST,  // Use actionTypes.REMOVE_TOAST
      toastId: toastId,
    })
  }, TOAST_REMOVE_DELAY)
...
export const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case actionTypes.DISMISS_TOAST: {  // Use actionTypes.DISMISS_TOAST
...
function useToast() {
  ...
  return {
    ...state,
    toast,
    dismiss: (toastId?: string) => dispatch({ type: actionTypes.DISMISS_TOAST, toastId }),  // Use actionTypes.DISMISS_TOAST
  }
}
